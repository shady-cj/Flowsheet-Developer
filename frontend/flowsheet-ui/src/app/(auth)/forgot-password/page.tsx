            ...
            <div className='flex flex-col gap-10 -mt-[10rem]'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <h1 className='text-[#16191C] text-[2.5rem] font-semibold leading-[3.1rem]'>Forgot Password</h1>
                    </div>
                </div>
                <form action={formAction} className='flex flex-col gap-y-5'>
                    <h2 className='text-[#666666] text-lg font-normal'>Please enter your email address to reset your password.</h2>
                    ...
                    <div>
                        <Link href="/login" className='text-[#2570BB] font-medium text-base'>Go back to Login</Link>
                    </div>
                </form>
            </div>
            </section>
