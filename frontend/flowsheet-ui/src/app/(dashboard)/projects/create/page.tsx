...
export default function ProjectCreate() {
    ...
    return (
        <section className="flex flex-col gap-y-2 xl:gap-y-4 h-full w-full px-6">
            <div className="flex justify-end w-full">
                <Link href="/projects" className="text-text-blue-variant text-base xl:text-lg font-medium flex flex-col hover:scale-105 transition">
                  Project List
