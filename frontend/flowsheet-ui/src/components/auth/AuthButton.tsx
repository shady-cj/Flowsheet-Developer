...
const Button = ({title}: {title: string}) => {
    ...
    return (
        <button type='submit' className={`rounded-md px-4 py-2 w-fit bg-[#282c33]
            ...
            disabled={pending}>
            {pending ? 
            <svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 text-white animate-spin -mr-2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
